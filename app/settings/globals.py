...
AWS_ACCESS_KEY_ID: str = config("AWS_ACCESS_KEY_ID", cast=str, default="DUMMY_AWS_ACCESS_KEY_ID")
AWS_SECRET_ACCESS_KEY: str = config("AWS_SECRET_ACCESS_KEY", cast=str, default="DUMMY_AWS_ACCESS_KEY_ID")
